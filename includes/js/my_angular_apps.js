...
//function triggerd when rows or columns are chan
	  ...
	  content+="<div class='row'><div class='large-5 columns'><input id='rating_subq_"+i+"' type='text'></div><div class='large-6 columns'><span class='rating'>";
 ...
 //preview function
	...
	preview_content+="<div class='row panel callout'><div class='large-6 columns'><h5>Q"+i+".&nbsp; "+sub_question+"</h5></div><div class='large-5 columns'><span class='rating'>";
			  for(j=1;j<=$scope.cols;j++){
