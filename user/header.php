...
<nav class="top-bar" data-topbar data-options="is_hover: false">
  ...
  <section class="top-bar-section">
    ...
    <ul class="middle">
	  <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>	
	  <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>	
      <li class="active"><a href="#"><i class="step fi-home size-24"></i>&nbsp;<b>Home</b></a></li>
	  <li class="divider"></li>
	  ...
	  <ul class="dropdown">
		   <li><a href="/RVR/rating"><i class="step fi-star size-24"></i>&nbsp; <b>Rating</b></a></li>
      <li><a href="/RVR/voting"><i class="step fi-like size-24"></i>&nbsp; <b>Voting</b></a></li>
      <li><a href="/RVR/ranking"><i class="step fi-list-number size-26"></i>&nbsp; <b>Ranking</b></a></li>
